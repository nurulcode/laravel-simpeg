        ...
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Avatar</h4>
                    <div class=""><img src="{{ asset('assets\images\small\img-2.jpg') }}"
            ...
            <form action="{{ route('pegawais.store') }}" enctype="multipart/form-data" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input name="tempat_lahir" value="{{ old('nama_lengkap') }}" type="text"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div>
                            <div class="input-group">
                                <input name="tanggal_lahir" value="{{ old('nama_lengkap') }}"
                                    type="text"
