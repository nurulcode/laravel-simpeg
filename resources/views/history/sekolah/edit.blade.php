                ...
                <form action="{{ route('sekolah.update', $sekolah->id) }}" method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="pegawai_id" value="{{ $sekolah->pegawai->nama_lengkap }}"class="form-control input-lg" placeholder="Pilih Pegawai" autocomplete="off" />
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input name="nama_sekolah" value="{{ $sekolah->nama_sekolah }}" type="text" class="form-control {{ $errors->has('nama_sekolah') ? 'is-invalid' : '' }} ">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input name="rektor" value="{{ $sekolah->rektor }}" type="text" class="form-control {{ $errors->has('rektor') ? 'is-invalid' : '' }}">
                        ...
                        <div class="form-group col-md-4">
                            <label>Lokasi</label>
                            <input name="lokasi" value="{{ $sekolah->lokasi }}" type="text" class="form-control {{ $errors->has('lokasi') ? 'is-invalid' : '' }} ">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input name="nomor" value="{{ $sekolah->nomor }}" type="text" class="form-control {{ $errors->has('nomor') ? 'is-invalid' : '' }}">
                            @if($errors->has('nomor'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div>
                                <div class="input-group">
                                    <input name="tgl_ijazah" value="{{ $sekolah->ijazah }}" type="text" autocomplete="off" class="form-control {{ $errors->has('tgl_ijazah') ? 'is-invalid' : '' }}" placeholder="mm/dd/yyyy" id="datepicker-autoclose">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control select2 {{ $errors->has('pendidikan_id') ? 'is-invalid' : '' }}" name="pendidikan_id">
                                ...
                                @foreach($pendidikans as $item)
                                    <option value="{{ $item->id }}" {{ $item->id == $sekolah->pendidikan_id ? 'selected' : '' }}>{{ $item->kategori }} - {{ $item->nama }}</option>
                                @endforeach
                            </select>
