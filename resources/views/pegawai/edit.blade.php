                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div>
                                <div class="input-group">
                                    <input value="{{ $pegawai->lahir }}" name="tanggal_lahir" type="text" class="form-control {{ $errors->has('tanggal_lahir') ? 'is-invalid' : '' }}" placeholder="mm/dd/yyyy" id="datepicker-autoclose">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div>
                                <div class="input-group">
                                    ...
                                    <div>
                                        <small class="text-danger">{{ $errors->first('tgl_naik_pangkat') }}</small>
                                    </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div>
                                <div class="input-group">
                                    ...
                                    <div>
                                        <small class="text-danger">{{ $errors->first('tgl_naik_gaji') }}</small>
                                    </div>
                                    @endif
                                </div>
                            </div>
